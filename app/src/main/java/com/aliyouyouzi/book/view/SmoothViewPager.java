...
import com.aliyouyouzi.book.utils.UIUtils;
...
public class SmoothViewPager extends RelativeLayout {
    ...
    private FlyPageAdapter mAdapter;

    public SmoothViewPager(Context context, int height) {
        this(context, null);
        this.mHeight = height;
    }
    ...
    public SmoothViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mPointsIsVisible = a.getBoolean(R.styleable.SmoothViewPager_points_visibility, true);
        mPointPosition = a.getInt(R.styleable.SmoothViewPager_points_position, CENTER);
        mPointContainerBackgroundDrawable
                = a.getDrawable(R.styleable.SmoothViewPager_points_container_background);
    ...
    private void addPoints() {
        ...
        ImageView imageView;
        int length = mIsImageUrl ? 5 : mImages.size();
